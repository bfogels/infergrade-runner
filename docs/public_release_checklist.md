...
The README should distinguish what works today from what is preview, planned, or limited. It should also state that Docker is optional for the first desktop/local benchmark path and may be needed for advanced sandboxed or container-friendly benchmark lanes.
