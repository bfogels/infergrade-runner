...
4. PR D: Desktop first-run smoke/static test improvements. In progress: pin token-free handoff, secure Rust upload, progress/artifact rendering, and selected-runtime guidance with static tests.
