...
build_image "infergrade-gpqa" "containers/capability-gpqa/Dockerfile"
build_image "infergrade-longbench-v2" "containers/capability-longbench-v2/Dockerfile"
build_image "infergrade-bfcl" "containers/capability-bfcl/Dockerfile"
build_image "infergrade-repository-edit" "containers/capability-repo-edit/Dockerfile"
...
echo "  infergrade-gpqa:${VERSION_TAG}"
echo "  infergrade-longbench-v2:${VERSION_TAG}"
echo "  infergrade-bfcl:${VERSION_TAG}"
echo "  infergrade-repository-edit:${VERSION_TAG}"
