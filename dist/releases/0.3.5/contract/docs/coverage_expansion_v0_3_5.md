...
2. Apple Silicon coding ladder for Qwen2.5-Coder with deployment, HumanEval+, and MBPP+ evidence.
3. Apple Silicon reasoning sample for Qwen2.5 with exact-answer and sampled MMLU-Pro evidence.
4. Windows/NVIDIA CUDA beta gate for one known-good Qwen2.5 Q4 path after hardware is available.
