...
class DesktopRunnerCapabilityTests(unittest.TestCase):
    ...
    def test_desktop_docs_keep_native_first_and_docker_optional(self):
        ...
        self.assertIn("installer-and-go first-run executor is still in progress", runner_readme)
        self.assertIn("installer-and-go native first-run executor is still in progress", desktop_readme)
