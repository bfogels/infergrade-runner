...
class DesktopRunnerCapabilityTests(unittest.TestCase):
    ...
    def test_desktop_docs_keep_native_first_and_docker_optional(self):
        ...
        self.assertIn("Runner-pinned managed fallback", runner_readme)
        self.assertIn("signed runtime-catalog metadata", runner_readme)
        self.assertIn("does not represent an upstream artifact signature", runner_readme)
        self.assertIn("Docker/Podman: optional", desktop_readme)
        self.assertIn("Managed fallback", desktop_readme)
        self.assertIn("Signed runtime catalog", desktop_readme)
        self.assertIn("Custom llama.cpp build", desktop_readme)
