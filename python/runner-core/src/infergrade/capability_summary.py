...
def _discover_capability_run_artifacts(execution: CapabilityExecution, output_dir: str) -> List[Dict[str, Any]]:
    ...
    for benchmark_id, paths in sorted(dict(execution.artifacts or {}).items()):
        ...
        artifact_benchmark_id = (
            artifact_protocol.get("task_version")
...
def _surface_summary(surface: str, artifact_pointers: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    if not surface_artifacts:
        ...
        return {
            ...
            "score_raw_attainment": missing_score_details.get("raw_attainment"),
            "score_calibration": missing_score_details.get("calibration"),
            ...
            "score_protocol_version": missing_score_details.get("protocol_version"),
            "score_protocol_label": missing_score_details.get("protocol_label"),
            "score_scale_interpretation": missing_score_details.get("scale_interpretation"),
            "score_ceiling_display_policy": missing_score_details.get("ceiling_display_policy"),
            "score_ceiling": missing_score_details.get("ceiling"),
            "score_diagnostic_components": missing_score_details.get("diagnostic_components", []),
            "score_ready": False,
    ...
    return {
        ...
        "score_raw_attainment": score_details.get("raw_attainment"),
        "score_calibration": score_details.get("calibration"),
        ...
        "score_protocol_version": score_details.get("protocol_version"),
        "score_protocol_label": score_details.get("protocol_label"),
        "score_scale_interpretation": score_details.get("scale_interpretation"),
        "score_ceiling_display_policy": score_details.get("ceiling_display_policy"),
        "score_ceiling": score_details.get("ceiling"),
        "score_diagnostic_components": list(score_details.get("diagnostic_components") or []),
